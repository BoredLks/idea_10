...
% ★ LMPC缓存决策
cache_decision = cal_cache_decision_1(h, total_users, F, iu_count_per_community, sbs_coverage, iu_coverage, nf, v_chi_star, D_eg, D_iu, sbs_positions, per_user_positions, iu_indices, iu_flags, user_file_req_prob);
