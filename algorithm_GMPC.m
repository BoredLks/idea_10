...
% ★ GMPC缓存决策
cache_decision = cal_cache_decision_4(h, user_per_community, total_users, F, iu_count_per_community, nf, v_chi_star, D_eg, D_iu, iu_indices, user_file_req_prob);
